...
suite('mapModalSubmitInputValues()', () => {
    test('Maps text input component values', () => {
        const mapped = mapModalSubmitInputValues({
            components: [
                {
    ...
    test('Maps file upload component values', () => {
        const mapped = mapModalSubmitInputValues({
            components: [
                {
                    type: ComponentType.Label,
    ...
    test('Maps checkbox, radio and group component values', () => {
        const mapped = mapModalSubmitInputValues({
            components: [
                {
                    type: ComponentType.Label,
